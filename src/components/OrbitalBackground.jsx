    ...
    class Orb {
      ...
      draw() {
        ...
        gradient.addColorStop(0, darkMode
          ...
          : `rgba(15, 158, 176, ${this.opacity * 0.7})`
        );
        gradient.addColorStop(0.5, darkMode
          ? `rgba(59, 130, 246, ${this.opacity * 0.5})`
          : `rgba(96, 165, 250, ${this.opacity * 0.4})`
        );
        gradient.addColorStop(1, 'rgba(15, 158, 176, 0)');
        ...
        ctx.strokeStyle = darkMode
          ? `rgba(15, 158, 176, ${this.opacity * 0.2})`
          : `rgba(15, 158, 176, ${this.opacity * 0.1})`;
        ctx.lineWidth = 1;
        ctx.beginPath();
